-- Script Simplificado - Apenas INSERTs
-- Paulimane - Materiais de Construção
...
-- PRODUTOS (60 produtos distribuídos pelas categorias)
-- Nota: CategoriaID deve corresponder aos IDs das categorias inseridas acima

-- Calhas e Algerozes (CategoriaID = 1)
...
-- Torneiras e Misturadoras (CategoriaID = 2)
INSERT INTO Produtos (Imagem, Nome, Descricao, CategoriaID) VALUES
...
-- Tubos e Conexões (CategoriaID = 3)
INSERT INTO Produtos (Imagem, Nome, Descricao, CategoriaID) VALUES
...
-- Portas e Janelas (CategoriaID = 4)
INSERT INTO Produtos (Imagem, Nome, Descricao, CategoriaID) VALUES
...
-- Ferragens e Fechaduras (CategoriaID = 6)
INSERT INTO Produtos (Imagem, Nome, Descricao, CategoriaID) VALUES
